...
<body>
  <div class="container">
    <div class="jumbotron" style="background-color: ${team};">
      <h1 class="display-4">You are in team <span class="badge badge-secondary">${team}</span></h1>
...
app.post('/submitForm', (req, res) => {
    ...
    db.query(sql, newUser, (err, result) => {
        ...
        let mailOptions = {
            ...
            text: `Hello ${fullName}, thanks for filling up the form. You are in team ${team}.` // plain text body
        };
